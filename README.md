...
> **R:**
Porque el preprocesador expande los #include copiando el contenido completo de los headers del sistema como stdio.h, lo que agrega cientos de líneas al archivo.
---
...
> **R:**
Porque el preprocesador elimina todos los comentarios antes de generar el archivo .i, ya que no son necesarios para la compilación.
...
> **R:** 
Estas instrucciones inicializan la función, guardan el estado previo y preparan la pila para ejecutar la suma de los parámetros.
...
> **R:**
Quedan símbolos indefinidos porque pertenecen a bibliotecas dinámicas del sistema. Estos son resueltos en tiempo de ejecución por el sistema operativo.
...
> **R:**
Una macro función como CUADRADO(x) es reemplazada directamente por el preprocesador antes de la compilación, sin verificación de tipos. En cambio, una función real como sumar(a, b) es procesada por el compilador, tiene verificación de tipos y genera código en tiempo de compilación. La macro desaparece en el preprocesamiento, mientras que la función se mantiene hasta el enlazado.
...
> **R:**
Un símbolo de tipo T representa código ejecutable (funciones) y se encuentra en la sección .text. Un símbolo de tipo D representa una variable global inicializada y se encuentra en la sección .data.
---
...
> **R:**
ntdll.dll => /c/WINDOWS/SYSTEM32/ntdll.dll (0x7ff91dc60000)
        ntdll.dll => /c/Windows/SysWOW64/ntdll.dll (0x77510000)
        wow64.dll => /c/WINDOWS/System32/wow64.dll (0x7ff91c590000)
        wow64base.dll => /c/WINDOWS/System32/wow64base.dll (0x7ff91da30000)
        wow64win.dll => /c/WINDOWS/System32/wow64win.dll (0x7ff91bb30000)
        wow64con.dll => /c/WINDOWS/System32/wow64con.dll (0x7ff91da10000)

¿Por qué `libc` no hubo que especificarla explícitamente al enlazar con `gcc`?

> **R:**
libc no se especifica explícitamente porque gcc la enlaza automáticamente al compilar, ya que es parte esencial del entorno de ejecución de C.
---
